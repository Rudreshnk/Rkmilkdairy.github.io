...
<?php
	...
	$b=$_POST['c_new_pass'];
		...
		$sql = "select * from login where username ='".$_SESSION['uname']."' and password='".$_POST['old_pass']."'";
		//echo $sql;
	if($a==$b)
	{
		$res = mysql_query($sql);
		...
		{
			$sql1 = "update login set password = '".$_POST['new_pass']."' where username ='".$_SESSION['uname']."'";
