...
<?php
  ...
  $sql="select * from kmf where kmf_id='$id'";
  $res=mysql_query($sql);
  ...
  ?>
  <?php include('val.php'); ?>
  <form name="form1" id="formID" method="post" action="KMF_update.php">
   <p>
    <input name="kmf_id" type="hidden" value="<?php echo $row['kmf_id']; ?>">
  </p>
  <table width="340" height="169" border="1">
    <tr>
      <td width="164">Milk_Type</td>
      <td width="152"><select name="milk_type" id="milk_type">
    ...
    <tr>
      <td>Total_Litre</td>
      <td><input name="total_litre" class="validate[required],custom[onlyNumber]"type="text" value="<?php echo $row['total_litre']; ?>"></td>
    </tr>
    <tr>
      <td>Sent_Date</td>
      <td><input name="sent_date" class="validate[required],custom[date]" type="date" value="<?php echo $row['sent_date']; ?>"></td>
    </tr>
    <tr>
      <td height="26">Cost_Per_Litre</td>
      <td><input name="cost_per_litre" class="validate[required],custom[onlyNumber]" type="text" value="<?php echo $row['cost_per_litre']; ?>"></td>
    </tr>
    <tr>
      <td height="37">Total_Amount</td>
      <td><input name="total_amount" class="validate[required],custom[onlyNumber]" type="text" value="<?php echo $row['total_amount']; ?>"></td>
    </tr>
    <tr>
