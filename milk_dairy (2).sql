...
(4, 'Rudresh', '8861338653', 'Haveri', '123456781234', '8901012155028');
...
INSERT INTO `employee` (`employee_id`, `username`, `employee_name`, `employee_contact`, `employee_address`, `monthly_salary`) VALUES
(2, 'san123', 'Sandeep', 9743320840, 'Dharwad', 12000),
(3, 'manju123', 'Manjunath', 9876543210, 'Hubli', 12000),
(4, 'chandru123', 'Chandru', 9535812559, 'Haveri', 12000);
...
(7, 4, '2020-03-08', 25000, 10000, 15000, '2020-03-08');
...
('san123', '123456', 'employee', 'Enter the registered cont', '9743320840'),
('manju123', '123456', 'employee', 'Enter the registered cont', '9876543210'),
('chandru123', '123456', 'employee', 'Enter the registered cont', '9535812559'),
('123456781234', '123456', 'depositor', 'My registered contact no', '8861338653');
...
(3, 0, '2020-03-08', '10', 20, 5, 'Cow'),
(4, 0, '2020-03-08', '10', 5, 4, 'Cow'),
(5, 4, '2020-03-08', '10', 10, 1, 'Cow');
